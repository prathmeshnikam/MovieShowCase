...
window.apiRequrstType = {
    GET: "GET",
    POST: "POST",
    DELETE: "DELETE"
}

window._addMultipleInService = function _addMultipleInService(allData){
...
window._addViewInDomInService = function _addMultipleInService(data){
    const app = document.getElementById('root')
    const container = document.createElement('div')
    container.setAttribute('class', 'container')
    app.appendChild(container)
