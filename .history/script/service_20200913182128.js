...
window._service_addViewInDomInService = function _service_addMultipleInService(data){
    const app = document.getElementById('root')
    const container = document.createElement('div')
    container.setAttribute('class', 'container')
    app.appendChild(container)
...
window._service_deleteElements = function _service_deleteElements(){
...
window._service_generateUniqueId = function _service_generateUniqueId(){
	let stringFourChar = () => {
...
window._service_showErrorMsg = function _service_showErrorMsg(msg){
